    ...
    return Object.keys(recipe).map(
        (key, index) =>
            new Recipe(
                ...
                recipe[key].cuisine,
                recipe[key].duration,
                recipe[key].servingSize,
                recipe[key].calories,
                recipe[key].image,
                recipe[key].ingredients,
                recipe[key].equipments,
                recipe[key].steps,
                { key: index }
            )
    );
...
exports.getRecipesByCaloriesIngredients = async (
    ingredients,
    minCalories,
    maxCalories
) => {
...
exports.addRecipe = async (newRecipe) => {
    ...
    return new Recipe(
        recipeRef.key,
        recipeRef.recipeName,
        recipeRef.cuisine,
        recipeRef.duration,
        recipeRef.servingSize,
        recipeRef.calories,
        recipeRef.images,
        recipeRef.ingredients,
        recipeRef.equipments,
        recipeRef.steps
    );
};
